...
static const char *getPredicateText_op(unsigned predicate) {
    ...
    switch (predicate) {
        case ICmpInst::ICMP_EQ:    pred = "EQ"; break;
        case ICmpInst::ICMP_NE:    pred = "NE"; break;
        case ICmpInst::ICMP_SGT:   pred = "GT"; break;
        case ICmpInst::ICMP_SGE:   pred = "GE"; break;
        case ICmpInst::ICMP_SLT:   pred = "LT"; break;
        case ICmpInst::ICMP_SLE:   pred = "LE"; break;
        case ICmpInst::ICMP_UGT:   pred = "GT"; break;
        case ICmpInst::ICMP_UGE:   pred = "GE"; break;
        case ICmpInst::ICMP_ULT:   pred = "LT"; break;
        case ICmpInst::ICMP_ULE:   pred = "LE"; break;


        case FCmpInst::FCMP_FALSE: pred = "FALSE"; break;
        case FCmpInst::FCMP_OEQ:   pred = "EQ"; break;
        case FCmpInst::FCMP_OGT:   pred = "GT"; break;
        case FCmpInst::FCMP_OGE:   pred = "GE"; break;
        case FCmpInst::FCMP_OLT:   pred = "LT"; break;
        case FCmpInst::FCMP_OLE:   pred = "LE"; break;
        case FCmpInst::FCMP_ONE:   pred = "NE"; break;
        //case FCmpInst::FCMP_ORD:   pred = "ord"; break;
        //case FCmpInst::FCMP_UNO:   pred = "uno"; break;
        case FCmpInst::FCMP_UEQ:   pred = "EQ"; break;
        case FCmpInst::FCMP_UGT:   pred = "GT"; break;
        case FCmpInst::FCMP_UGE:   pred = "GE"; break;
        case FCmpInst::FCMP_ULT:   pred = "LT"; break;
        case FCmpInst::FCMP_ULE:   pred = "LE"; break;
        case FCmpInst::FCMP_UNE:   pred = "NE"; break;
        case FCmpInst::FCMP_TRUE:  pred = "TRUE"; break;
...
static const char *getPredicateText_op_reverse(unsigned predicate) {
    ...
    switch (predicate) {
        ...
        case ICmpInst::ICMP_EQ:    pred = "NE"; break;
        case ICmpInst::ICMP_NE:    pred = "EQ"; break;
        case ICmpInst::ICMP_SGT:   pred = "LE"; break;
        case ICmpInst::ICMP_SGE:   pred = "LT"; break;
        case ICmpInst::ICMP_SLT:   pred = "GE"; break;
        case ICmpInst::ICMP_SLE:   pred = "GT"; break;
        case ICmpInst::ICMP_UGT:   pred = "LE"; break;
        case ICmpInst::ICMP_UGE:   pred = "LT"; break;
        case ICmpInst::ICMP_ULT:   pred = "GE"; break;
        case ICmpInst::ICMP_ULE:   pred = "GT"; break;

        case FCmpInst::FCMP_FALSE: pred = "TRUE"; break;
        case FCmpInst::FCMP_OEQ:   pred = "NE"; break;
        case FCmpInst::FCMP_OGT:   pred = "LE"; break;
        case FCmpInst::FCMP_OGE:   pred = "LT"; break;
        case FCmpInst::FCMP_OLT:   pred = "GE"; break;
        case FCmpInst::FCMP_OLE:   pred = "GT"; break;
        case FCmpInst::FCMP_ONE:   pred = "EQ"; break;
        //case FCmpInst::FCMP_ORD:   pred = "ord"; break;
        //case FCmpInst::FCMP_UNO:   pred = "uno"; break;
        case FCmpInst::FCMP_UEQ:   pred = "NE"; break;
        case FCmpInst::FCMP_UGT:   pred = "LE"; break;
        case FCmpInst::FCMP_UGE:   pred = "LT"; break;
        case FCmpInst::FCMP_ULT:   pred = "GE"; break;
        case FCmpInst::FCMP_ULE:   pred = "GT"; break;
        case FCmpInst::FCMP_UNE:   pred = "EQ"; break;
        case FCmpInst::FCMP_TRUE:  pred = "FALSE"; break;
...
//             errs()<<"0ConstantInt isa<GlobalValue>:"<<a;
             double s=a.signedRoundToDouble();//llvm::APIntOps::RoundAPIntToDouble(a);
                ...
                if(isConstantVal(v1)){                                      
                    ...
                    if(EI->getOpcode() != Instruction::GetElementPtr)
                        ...
                        if(cfg->hasVariable(varName1)){
                            ...
                            p2.varList.push_back(new Variable(varName1,var->ID,PTR));
                        }
                        else
                        ...
                        for(int i=0; i<(int)n2-1; i++){
                            ...
                            if(isConstantVal(v2))
                                p2.varList.push_back(new Variable(varNum1,-1,NUM));
                            else 
                ...
                if(isa<ConstantExpr>(v1)){
                    ...
                    if(EI->getOpcode() != Instruction::GetElementPtr)
                        ...
                        if(cfg->hasVariable(varName)){
                            ...
                            p2.varList.push_back(new Variable(varName,var->ID,PTR));
                        }
                        else
                        ...
                        for(int i=0; i<(int)n2-1; i++){
                            ...
                            if(isConstantVal(v2))
                                p2.varList.push_back(new Variable(varNum,-1,NUM));
                            else 
...
//        }
        ...
        if(pTemp2.op==MUL&&pTemp2.lvar->type!=NUM&&pTemp2.rvar->type!=NUM)
            cfg->setUnlinear();
        else if(pTemp2.op==DIV&&pTemp2.rvar->type!=NUM)
            cfg->setUnlinear();
...
//**********************set to transition********************************************
                    ...
                    if(isa<ConstantExpr>(v1)){
                        ...
                        if(EI->getOpcode() == Instruction::GetElementPtr){
                            ...
                            if(cfg->hasVariable(varName)){
                                ...
                                pt2.varList.push_back(new Variable(varName,var->ID,PTR));
                            }
                            else
                            ...
                            for(int j=0; j<(int)n2-1; j++){
                                ...
                                string varNum = getVariableName(Out, v2, &TypePrinter, &Machine, TheModule);
                                if(isConstantVal(v2))
                                    pt2.varList.push_back(new Variable(varNum,-1,NUM));
                                else 
    ...
    */
    ...
    // **************************Deal with Defined Functions can't handle(return)****************************
        ...
        if(cfg->hasVariable(varName))
            pTemp2.varList.push_back(new Variable(varName,cfg->getVariable(varName)->ID,PTR));
        else
        ...
        for(int i=0; i<(int)n1-1; i++){
            ...
            varName = func+"_"+varNum;
            if(isConstantVal(v1))
                pTemp2.varList.push_back(new Variable(varNum,-1,NUM));
            else if(cfg->hasVariable(varName)){
                Variable *var = cfg->getVariable(varName);
 ...
 //               errs()<<"1.LOG\t"<<*s<<"\n";
            ...
            if(cfg->hasVariable(varName)){
                ...
                if(cfg->hasVariable(tempName))
                    ...
                    Variable tvar(tempName, cfg->counter_variable++, type);
                    cfg->variableList.push_back(tvar);
                    pTemp1.rvar = new Variable(tvar);
                    pTemp1.isExp=false;
                    cTemp.lpvList = pTemp1;
...
//                errs()<<"1.TRI\t"<<*s<<"\n";
    ...
    //divided by zero
        ...
        if(cfg->hasVariable(varName)){
            ...
            pTemp2.rvar = new Variable(double2string(precision),-1,NUM);
            pTemp2.isExp = false;
            cTemp.op=LT;
            cTemp.rpvList = pTemp2;
