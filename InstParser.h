...
namespace llvm {
    ...
    class InstParser {
        ...
        public:
            ...
            void setConstraint(CFG *cfg, State * &s, BasicBlock::iterator &it, string func, int bound, DebugInfo *dbg);
            ...
            void preprocess(CFG* cfg, State* &s, const Instruction* I, string func, vector<int> &target);
