...
enum Op_m{
    AND,NAND,OR,XOR,ADD,SUB,
    TAN,ATAN,ATAN2,SIN,ASIN,COS,ACOS,SQRT,POW,LOG,LOG10,ABS,EXP,
    SINH,COSH,TANH,MUL,DIV,NONE,
    ADDR,GETPTR,STORE,LOAD,ALLOCA,SREM,ASHR,SHL,
    lt,le,gt,ge,eq,ne
};
